DROP DATABASE IF EXISTS libaraydb;
create database libaraydb;
grant all privileges on libaraydb.* to mysejong@localhost with grant option;
commit;
...
CREATE TABLE `material` (
  ...
  FOREIGN KEY (`lib_no`) REFERENCES `libaray`(`lib_no`),
